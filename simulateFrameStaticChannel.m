function [errorCount, errorRatio, timeErr, frequencyErr, channelErr] = simulateFrameStaticChannel(SNRdB)
% Simulaton of a frame consisting of 68 OFDM symbols
    ...
    % same channel for all symbols
    channel = repmat(modules.channelGenerator(),68,1);
